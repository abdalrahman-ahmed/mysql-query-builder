module.exports = {
  SELECT: {
    ...
    6: "SELECT t1.id, t1.name, t2.email, t3.school FROM table1 as t1 INNER JOIN table2 as t2 ON t2.userId=t1.id LEFT JOIN table3 as t3 ON t3.userId=t1.id WHERE `t1.id`=5 LIMIT 0, 1000;",
    7: "SELECT t1.id, t1.name, t2.email, t3.school, t4.nikname FROM table1 as t1 INNER JOIN table2 as t2 ON t2.userId=t1.id LEFT JOIN table3 as t3 ON t3.userId=t1.id RIGHT JOIN table4 as t4 ON t4.userId=t1.id WHERE `t1.id`=5 LIMIT 0, 1000;",
